...
class OrderCard extends StatelessWidget {
  ...
  const OrderCard({super.key, required this.order, this.onStatusUpdated});
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    if (order.deliveryMethod == 'pickup') ...[
                      ...
                      Container(
                        ...
                        child: Text(
                          Translate.get('pickupOrder').toUpperCase(),
                ...
                Container(
                  ...
                  child: Text(
                    (order.deliveryMethod == 'pickup' &&
                        ...
                        ? Translate.get('readyToPickup').toUpperCase()
            ...
            if (order.seatInfo.isNotEmpty) ...[
              ...
              Row(
                children: [
                  Icon(Icons.chair, size: 16, color: theme.colorScheme.primary),
                  const SizedBox(width: 8),
                  Text(
