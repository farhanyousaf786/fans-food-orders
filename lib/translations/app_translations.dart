class AppTranslations {
  ...
  static const Map<String, Map<String, String>> translations = {
    'en': {
      ...
      'refresh': 'Refresh',
      'sign_out': 'Sign Out',
      'loading_shops': 'Loading your shops...',
      'no_shops_found': 'No Shops Found',
      'no_shops_assigned': 'You are not assigned to any shops yet.',
      ...
      'item': 'item',
      'notification_permission_status': 'Notification permission status',
      'error_requesting_permissions': 'Error requesting permissions',
      'fcm_token_is_null': 'FCM token is null',
      'error_getting_fcm_token': 'Error getting FCM token',
      'counter_smoke_test': 'Counter increments smoke test',
      'pending': 'Pending',
      'preparing': 'Preparing',
      ...
      'error_prefix': 'Error: ',
      'update_order_status_title': 'Update Order Status',
      'select_new_status_prompt': 'Select the new status for this order:',
      'confirm_status_update_title': 'Confirm Status Update',
      'confirm_status_update_prompt': 'Change order status to {status}?',
    ...
    'he': {
      ...
      'emailLabel': 'אימייל',
      'emailRequiredError': 'אנא הזן את האימייל שלך',
      'emailInvalidError': 'אנא הזן אימייל חוקי',
      'passwordLabel': 'סיסמה',
      'passwordRequiredError': 'אנא הזן את סיסמתך',
      ...
      'error_prefix': 'שגיאה: ',
      'update_order_status_title': 'עדכן סטטוס הזמנה',
      'select_new_status_prompt': 'בחר את הסטטוס החדש להזמנה זו:',
      'confirm_status_update_title': 'אשר עדכון סטטוס',
      'confirm_status_update_prompt': 'לשנות את סטטוס ההזמנה ל-{status}?',
      'confirm_button': 'אשר',
      'close_button': 'סגור',
      ...
      'refresh': 'רענן',
      'sign_out': 'התנתק',
      'loading_shops': 'טוען את החנויות שלך...',
      'no_shops_found': 'לא נמצאו חנויות',
      'no_shops_assigned': 'עדיין לא הוקצו לך חנויות.',
      'sign_out_confirmation': 'האם אתה בטוח שברצונך להתנתק?',
      'updated': 'עודכן',
      'location_services_disabled': 'שירותי מיקום מושבתים.',
      'location_permissions_denied': 'הרשאות מיקום נדחו',
      'location_permissions_denied_forever': 'הרשאות מיקום נדחו לצמיתות',
      'location_updated_to': 'מיקום עודכן ל',
      'failed_to_update_location': 'נכשל בעדכון המיקום במסד הנתונים',
      'error_updating_location': 'שגיאה בעדכון המיקום',
      ...
      'name': 'שם',
      'phone': 'טלפון',
      'delivery_information': 'פרטי משלוח',
      'area': 'אזור',
      'entrance': 'כניסה',
      'row': 'שורה',
      'seat_no': 'מספר מושב',
      'seat_details': 'פרטי מושב',
      'section': 'מקטע',
      'stand': 'יציע',
      'user_not_found': 'לא נמצא משתמש עם אימייל זה.',
      'wrong_password': 'סיסמה שגויה.',
      'email_already_in_use': 'האימייל כבר רשום.',
      'invalid_email': 'כתובת אימייל לא תקינה.',
      'weak_password': 'הסיסמה חלשה מדי.',
      'authentication_failed': 'האימות נכשל. אנא נסה שוב.',
      'unexpected_error': 'אירעה שגיאה בלתי צפויה.',
      'new_order': 'הזמנה חדשה',
      'new_order_received': 'התקבלה הזמנה חדשה',
      'you_have_new_order': 'יש לך הזמנה חדשה!',
      ...
      'item': 'פריט',
      'notification_permission_status': 'סטטוס הרשאת התראות',
      'error_requesting_permissions': 'שגיאה בבקשת הרשאות',
      'fcm_token_is_null': 'אסימון FCM ריק',
      'error_getting_fcm_token': 'שגיאה בקבלת אסימון FCM',
      'counter_smoke_test': 'בדיקת עשן של מונה מצטבר',
      'pending': 'ממתין',
      'preparing': 'בהכנה',
      'delivering': 'במשלוח',
      'delivered': 'נמסר',
